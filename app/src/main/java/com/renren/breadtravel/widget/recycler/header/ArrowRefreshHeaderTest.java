package com.renren.breadtravel.widget.recycler.header;
...
import com.renren.breadtravel.widget.recycler.interfaces.BaseRefreshHeader;

import java.util.Date;


import static com.renren.breadtravel.widget.recycler.interfaces.BaseRefreshHeader.STATE_NORMAL;


public class ArrowRefreshHeaderTest extends LinearLayout implements BaseRefreshHeader {
    ...
    public ArrowRefreshHeaderTest(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public ArrowRefreshHeaderTest(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
